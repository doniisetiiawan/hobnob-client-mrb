...
When(
  /^user types in an? (in)?valid (\w+) in the ["']([.#\w-]+)["'] element$/,
  async function (invalid, type, selector) {
...
Then(
  /^user types in his\/her (\w+) in the ["']([.#\w-]+)["'] element$/,
  async function (contextKey, selector) {
